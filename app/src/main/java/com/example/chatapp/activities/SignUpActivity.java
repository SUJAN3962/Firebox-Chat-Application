...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void setListeners(){
        ...
        binding.togglePasswordVisibilityButton.setOnClickListener(v -> {
            togglePasswordVisibility();
        });
        binding.toggleConfirmPasswordVisibilityButton.setOnClickListener(v -> {
    ...
    private boolean isValidSignUpDetails() {
        ...
        else if(!(validatepass(binding.inputPassword.getText().toString().trim()))){
            showToast("Password must contain Uppercase lowercase numbers and special characters(@!#$%&)");
            return false;
        }
        else
            return true;
    ...
    private void togglePasswordVisibility() {
        if (binding.inputPassword.getTransformationMethod() == PasswordTransformationMethod.getInstance() ) {
            // Password is currently hidden, so unhide it
