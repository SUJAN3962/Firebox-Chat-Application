...
public class SignInActivity extends AppCompatActivity {
    ...
    private void setListeners() {
        ...
        binding.togglePasswordVisibilityButton2.setOnClickListener(view -> {
            togglePassword();
        });
    }
    ...
    private void togglePassword(){
        if(binding.inputPassword.getTransformationMethod() == PasswordTransformationMethod.getInstance()){
            ...
            binding.togglePasswordVisibilityButton2.setBackgroundDrawable(getDrawable(R.drawable.ic_hide));
        }
        else{
            binding.inputPassword.setTransformationMethod(PasswordTransformationMethod.getInstance());

            binding.togglePasswordVisibilityButton2.setBackgroundDrawable(getDrawable(R.drawable.ic_show));
        }
    }
}